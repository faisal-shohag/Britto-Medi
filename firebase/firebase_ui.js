(function () {
  ...
  (function () {
    ...
    function ge(a, b) {
      ...
      c in a.a &&
        Na(a.a[c], b) &&
        (de(b), 0 == a.a[c].length && (delete a.a[c], a.g--));
    }
    function fe(a, b, c, d) {
        ...
        ((d = ta(d) ? !!d.capture : !!d), (c = me(c)), a && a[ae])
          ? ((a = a.J),
            ...
            b in a.a &&
              ...
              (c = fe(f, c, d, e)),
              -1 < c &&
                (de(f[c]), Oa(f, c), 0 == f.length && (delete a.a[b], a.g--))))
          : a &&
            (a = oe(a)) &&
            ((b = a.a[b.toString()]),
            (a = -1),
    ...
    function te(a) {
      if ("number" != typeof a && a && !a.sa) {
        ...
        if (b && b[ae]) ge(b.J, a);
          ...
          je--;
          (c = oe(b))
            ? (ge(c, a), 0 == c.g && ((c.src = null), (b[he] = null)))
            : de(a);
        }
      }
    }
    ...
    function Be(a, b) {
      ...
      a = Ce(a);
      if (ze[a] && ze[a].length)
        for (var c = 0; c < ze[a].length; c++) xe(ze[a][c], b);
    }
    function De(a) {
      var b = Ce(a.N());
      ze[b] &&
    ...
    function Xe(a, b, c) {
      if (a.a == We) {
        a === c &&
          ((b = $e), (c = new TypeError("Promise cannot resolve to itself")));
        a.a = 1;
        a: {
          var d = c,
            e = a.hc,
    ...
    function H(a) {
      ...
      b &&
        !a &&
        tg("Privacy Policy URL is missing, the link will not be displayed.");
      if (b && a) {
    ...
    function J(a) {
      ...
      c &&
        !b &&
        tg("Term of Service URL is missing, the link will not be displayed.");
      if (b && c) {
    ...
    function Ui(a, b) {
      a.classList
        ? a.classList.add(b)
        : Ti(a, b) || (a.className += 0 < a.className.length ? " " + b : b);
    }
    function Vi(a, b) {
      a.classList
    ...
    l.handleEvent = function (a) {
      ...
      if (z && "keypress" == a.type) {
        ...
        (ec || bc) && "keypress" == a.type
          ? ((d = this.X),
            (e =
              0 <= b.charCode && 63232 > b.charCode && Zi(d) ? b.charCode : 0))
          : ac && !ec
      ...
      (dc &&
        vj &&
        "keypress" == a.type &&
        !$i(f, this.R, a.shiftKey, a.ctrlKey, c, a.metaKey)) ||
        ((a = f == this.R),
        (this.R = f),
        (b = new xj(f, e, a, b)),
        (b.altKey = c),
    ...
    function N(a, b) {
      ...
      b
        ? (Vi(a, "firebaseui-input-invalid"),
          Ui(a, "firebaseui-input"),
          c && Vi(c, "firebaseui-textfield-invalid"))
        : (Vi(a, "firebaseui-input"),
          Ui(a, "firebaseui-input-invalid"),
          c && Ui(c, "firebaseui-textfield-invalid"));
    }
    function Jj(a, b, c) {
      b = new oj(b);
      Sd(a, za(Td, b));
    ...
    function ek(a) {
      ...
      b =
        "" +
        ck({ Ab: D("firebaseui-list-box-dialog"), content: td(b + "</div>") });
      return B(b);
    }
    ...
    function Ak(a, b, c) {
      ...
      b &&
        (d +=
          ...
          "</div>");
      d +=
        '</div><div class="firebaseui-card-footer">' + Zj(c) + "</div></div>";
      return B(d);
    }
    ...
    function Nk(a, b, c) {
      ...
      d
        ? ((d =
            "<strong>" +
            (A(d) + "</strong> is not authorized to view the requested page.")),
          (e += d))
        : (e += "User is not authorized to view the requested page.");
      e += "</p>";
      b &&
        ((b =
          "Please contact <strong>" + (A(b) + "</strong> for authorization.")),
        (e +=
    ...
    function hl(a, b, c) {
      ...
      for (var e = 0; e < b; e++) {
        ...
        f.V
          ? (g += A(f.V))
          : ((f = "Sign in to " + A(f.displayName)), (g += f));
        g = B(
          g +
            ('</span><span class="firebaseui-idp-text firebaseui-idp-text-short">' +
              h +
    ...
    function pl() {
      ...
      Wi(a)
        ? (N(a, !0), Nj(b), (b = !0))
        : (N(a, !1), Oj(b, C("Enter your password").toString()), (b = !1));
      return b ? Wi(a) : null;
    }
    ...
    function wl() {
      ...
      c
        ? rl.test(c)
          ? (N(a, !0), Nj(b), (b = !0))
          : (N(a, !1),
            Oj(b, C("That email address isn't correct").toString()),
            (b = !1))
        : (N(a, !1),
          Oj(b, C("Enter your email address to continue").toString()),
          (b = !1));
    ...
    function T(a) {
      ...
      try {
        return (
          ...
          og("Internal error: " + a.message, void 0),
          Jd().toString()
        );
      } catch (d) {
        return a.message;
          ...
          .then(
            function (f) {
              ...
              f.length
                ...
                : (Ah(X(a)),
                  L("passwordRecovery", a, e, c, !1, Kd().toString()));
            },
            function (f) {
              km(a, b, f);
            }
    ...
    function rm() {
      ...
      this.Ra
        ? ((b.type = "text"),
          Ui(a, "firebaseui-input-toggle-off"),
          Vi(a, "firebaseui-input-toggle-on"))
        : ((b.type = "password"),
          Ui(a, "firebaseui-input-toggle-on"),
          Vi(a, "firebaseui-input-toggle-off"));
      b.focus();
    }
    function sm() {
                ...
                if (!f.name || "cancel" != f.name)
                  switch (f.code) {
                    ...
                    case "auth/too-many-requests":
                      ...
                      break;
                    default:
                      og("signInWithEmailAndPassword: " + f.message, void 0),
                        b.a(T(f));
                  }
              }
            )
    ...
    Ym.prototype.v = function () {
      ...
      this.B
        ? (uk(this, this.i(), this.u()), uk(this, this.u(), this.l()))
        : uk(this, this.i(), this.l());
    ...
    u(Ym.prototype, {
      ...
      M: function () {
        ...
        c
          ? (Nj(b), (b = !0))
          : (Oj(b, C("Enter your account name").toString()), (b = !1));
        return b ? Ua(Wi(a)) : null;
      },
      l: pm,
      ba: sm,
        ...
        .then(
          function (g) {
            g.length
              ...
              : ((g = Q(b)),
                b.m(),
                L("passwordRecovery", a, g, c, !1, Kd().toString()));
          },
          function () {
            e();
          }
    ...
    dn.prototype.w = function () {
      ...
      0 < this.B
        ? this.U(this.B)
        : (ij(this.i), se(this.i, "tick", this.w), this.ua(), this.lb());
    };
    u(dn.prototype, {
      u: an,
      pa: bn,
      ...
      U: function (a) {
        $c(
          cn.call(this),
          C("Resend code in " + ((9 < a ? "0:" : "0:0") + a)).toString()
        );
      },
      ua: function () {
        Nj(this.Fb());
    ...
    function kn(a, b) {
      ...
      for (var c = 0; c < a.length; c++)
        if (hn(a[c], "listboxid") === b) return a[c];
      return null;
    }
    function ln() {
    ...
    u(un.prototype, {
      ...
      ea: function (a, b, c) {
        ...
        Jj(this, e, function () {
          ...
          I.length &&
            I[0].b != t.b &&
            ((t = I[0]), qn.call(d, "1" == t.b && p ? "1-US-0" : t.c, h));
        });
        c &&
          Kj(this, e, function () {
            c();
      ...
      U: function (a) {
        ...
        if (d.length && !Ma(c, d[0]))
          throw (
            ...
            Oj(
              nn.call(this),
              C("The country code provided is not supported.").toString()
            ),
    ...
    function Lm(a, b, c, d, e) {
      ...
      c = f
        ...
        : U(a)
            ...
            .then(function (h) {
              return h.length
                ? Hn(a, { code: "auth/email-already-in-use" }, g)
    ...
    function $n(a) {
      ...
      c &&
        !b &&
        tg("Terms of Service URL is missing, the link will not be displayed.");
      if (b && c) {
        if ("function" === typeof c) return c;
        if ("string" === typeof c)
          return function () {
            ...
            c.g = new Qn(
              function () {
                ...
                if (t) {
                  ...
                  c.g.a(
                    Ld({ code: "no-matching-tenant-for-email" }).toString()
                  );
                }
              },
              Zn(c.a[d]),
    ...
    l.Zb = function (a, b) {
      ...
      return new Ve(function (d, e) {
        ...
        e.uiChanged = function (I, Ca) {
          null === I && "callback" === Ca
            ? ((I = Vc("firebaseui-id-page-callback", c.s)) && Nj(I),
              (c.h = new Tn()),
              c.h.render(c.s))
            : p ||
              (null === I && "spinner" === Ca) ||
